import type { StickerPackManifest } from '@talkapps/stickers-client';


/**
 * A sticker pack's "metadata" is an object containing its ID and decryption key
 * as well as any other information that does _not_ come from the Talk API.
 */
export interface StickerPackMetadata {
  ...
  /**
   * 64-character alphanumeric string required to decrypt responses from Talk.
   */
  key: string;
 ...
 *    plugin fetches from Talk at build-time.
